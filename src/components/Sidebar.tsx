  ...
  return (
    <aside className="w-[92px] h-full bg-sidebar/80 backdrop-blur-2xl flex flex-col py-6 px-4 flex-shrink-0 relative z-10 border-r border-border-primary">
      <div className="flex items-center justify-center mb-9">
        <div className="w-11 h-11 flex items-center justify-center rounded-2xl bg-text-primary text-primary shadow-[0_18px_50px_rgba(255,255,255,0.12)]">
            ...
            <NavLink
              ...
              className={({ isActive }) =>
                cn(
                  ...
                  isActive
                    ? 'bg-bg-tertiary text-text-primary shadow-[0_14px_38px_rgba(0,0,0,0.18)]'
